...
//import Logo from './../public/assets/all.png'
class Game extends Component{

  constructor(props){
      super(props)
      this.state={
        cards: ['Daffy','bugs','Tweety', 'taz', 'sylvester', 'porky'],
        dublicatedCards: [],
        randomizeCards: [],
        finalCards: [],
        openedCards: [] }
  ...
  render(){
      return(
          <div className="ground"> 
              <img src="/assets/looney-tunes.png" className="header"/>
              {
          ...
          <div className= {"card" + (!this.props.close ? 'opened' : '') + (this.props.complete ? 'matched': '')}
               onClick = {() => this.clicked(this.props.card)}>
                <>
                   ...
                   <div className = "back">
                         <img src={"/assets/"+this.props.card+".png"} alt={this.props.card} className="foto"/>
